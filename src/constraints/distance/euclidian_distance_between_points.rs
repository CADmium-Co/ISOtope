...
mod tests {
    ...
    use crate::{
        constraints::{distance::euclidian_distance_between_points::EuclidianDistanceBetweenPoints, Constraint}, primitives::point2::Point2, sketch::Sketch,
    };
    ...
    fn test_euclidian_distance_between_points() {
        ...
        let constr1 = Rc::new(RefCell::new(EuclidianDistanceBetweenPoints::new(point_a.clone(), point_b.clone(), 3.0)));
        ...
        println!("distance: {:?}", (point_a.as_ref().borrow().data() - point_b.as_ref().borrow().data()).norm());
