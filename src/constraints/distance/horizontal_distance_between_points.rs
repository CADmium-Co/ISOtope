...
#[derive(Debug)]
pub struct HorizontalDistanceBetweenPoints {
...
impl HorizontalDistanceBetweenPoints {
    pub fn new(
        point1: Rc<RefCell<Point2>>,
        point2: Rc<RefCell<Point2>>,
        desired_distance: f64,
...
impl Constraint for HorizontalDistanceBetweenPoints {
    ...
    fn update_gradient(&mut self) {
        ...
        let grad_distance_from_d = Matrix1x2::<f64>::new(1.0, 0.0);
...
mod tests {
    ...
    use crate::{
        constraints::{distance::horizontal_distance_between_points::HorizontalDistanceBetweenPoints, Constraint}, primitives::point2::Point2, sketch::Sketch,
    };
    ...
    fn test_horizontal_distance_between_points() {
        ...
        let constr1 = Rc::new(RefCell::new(HorizontalDistanceBetweenPoints::new(point_a.clone(), point_b.clone(), -3.0)));
        ...
        println!("distance: {:?}", (point_b.as_ref().borrow().x() - point_a.as_ref().borrow().x()));
