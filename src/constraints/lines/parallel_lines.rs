...
impl Constraint for ParallelLines {
    ...
    fn update_gradient(&mut self) {
        ...
        self.line1
            .borrow_mut()
            .add_to_gradient((grad_from_cross_product * grad_cross_product_from_dir1 * (grad_end1 - grad_start1)).as_view());

        self.line2
            .borrow_mut()
            .add_to_gradient((grad_from_cross_product * grad_cross_product_from_dir2 * (grad_end2 - grad_start2)).as_view());
...
mod tests {
    ...
    use crate::{
        constraints::{lines::parallel_lines::ParallelLines, Constraint}, primitives::{line::Line, point2::Point2}, sketch::Sketch
    };
    ...
    fn test_parallel_line() {
        ...
        let constr1 = Rc::new(RefCell::new(ParallelLines::new(line1.clone(), line2.clone())));
